...
class CliHandlerFunctions
{
    ...
    public static function serve($host = '127.0.0.1', $requestedPort = null)
    {
    ...
    public static function help()
    {
        ...
        \033[36mGenerators:\033[0m
          ...
          \033[33mmake:controller Name --api\033[0m     Create a new api controller class
          ...
          \033[33mmake:seeder Name\033[0m               Create a new seeder class
          \033[33mmake:component Name\033[0m            Create a new Vue3 component
          \033[33mmake:component Name --vue2\033[0m     Create a new Vue2 component
        ...
        \n\n
        TEXT;
        echo "\033[36mCLI: frame | Powered by QuickFrame \033[35mv" . Framework::version() . "\033[0m\n";
    }
}